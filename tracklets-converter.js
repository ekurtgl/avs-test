...
export default class TrackletsConverter {
  constructor(directory, getPoses) {
    ...
    this.TRACKLETS_PRED = '/tracklets/prediction';
  }
  ...
  getMetadata(xvizMetaBuilder) {
    ...
    xb.stream(this.TRACKLETS)
      ...
      .stream(this.TRACKLETS_PRED) // add prediction
      .category('primitive')
      .type('text')
      .streamStyle({
	    fill_color: '#DCDCCD',
  ...
  _convertTrackletsFrame(frameIndex) {
    ...
    return this.data.objects
      ...
      .map(object => {
        ...
        const {tx, ty, tz, rx, ry, rz, prob} = pose;
